...
/**
 * Port d'entrée : enregistrer un nouveau device simulé, orphelin et joignable
 * par défaut (voir ADR 0021/0024) — id et {@code friendlyName} initial générés
 * par le mock lui-même.
 */
public interface RegisterSimulatedDeviceUseCase {

	SimulatedDevice register(DeviceType type, String label);
