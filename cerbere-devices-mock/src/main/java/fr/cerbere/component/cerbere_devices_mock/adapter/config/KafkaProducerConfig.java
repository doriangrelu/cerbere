...
/**
 * Configuration explicite du producteur Kafka typé {@link EventEnvelope},
...
public final class KafkaProducerConfig {
	...
	@Bean
	public KafkaTemplate<String, EventEnvelope> deviceEventKafkaTemplate(
			final ProducerFactory<String, EventEnvelope> deviceEventProducerFactory) {
